...
@section('page-level-scripts')
    <script src="{{mix('themes/admins/e-shop/gorlabs/js/vmap.js')}}"></script>
    <script src="{{mix('themes/admins/e-shop/gorlabs/js/chart.js')}}"></script>
    <script src="{{mix('themes/admins/e-shop/gorlabs/js/demo.js')}}"></script>
    <script>
        Circles.create({
            id:'circles-1',
            radius:45,
